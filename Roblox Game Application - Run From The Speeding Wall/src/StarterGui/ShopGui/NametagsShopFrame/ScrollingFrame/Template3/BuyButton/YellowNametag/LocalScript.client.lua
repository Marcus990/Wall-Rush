...
local function whatdoicallthisfunctionversion2(stringvalue)
	...
	elseif stringvalue == "Unequip" then
		button.Parent.ImageColor3 = Color3.fromRGB(252, 1, 7)
		button.Text = "Unequip"
		player.Character.Head:FindFirstChild("newtext").UpperText.TextColor3 = Color3.fromRGB(255, 255, 10)
	end
end
...
button.MouseButton1Down:Connect(function()
	...
	elseif button.Text == "Unequip" then
		if player.Character.Head:FindFirstChild("newtext").UpperText.TextColor3 == Color3.fromRGB(255, 255, 10) then
	...
	elseif player.leaderstats.Coins.Value >= 50 and button.Text == "Buy" then
		...
		wait(2)
		button.Text = "Equip"
		TrailForDatastoreEvent:FireServer(24, game.Players.LocalPlayer)
	elseif player.leaderstats.Coins.Value < 50 and button.Text == "Buy" then
...
YellowNametagForDatastoreEvent.OnClientEvent:Connect(whatdoicallthisfunctionversion2)
