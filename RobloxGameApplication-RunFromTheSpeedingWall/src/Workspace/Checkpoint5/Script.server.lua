...
function onTouched(hit)
	if hit and hit.Parent and hit.Parent:FindFirstChildOfClass("Humanoid") and not debounce then
		...
		game.ReplicatedStorage.Events:WaitForChild("ChangeColorAndPlayFinishedSound"):FireClient(player, "Checkpoint5")
		game.ReplicatedStorage.Events.Checkpoint5Touched:FireClient(player)
