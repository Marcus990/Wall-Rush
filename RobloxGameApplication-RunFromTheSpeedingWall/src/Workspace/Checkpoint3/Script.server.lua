...
function onTouched(hit)
	if hit and hit.Parent and hit.Parent:FindFirstChildOfClass("Humanoid") and not debounce then
		...
		game.ReplicatedStorage.Events:WaitForChild("ChangeColorAndPlayFinishedSound"):FireClient(player, "Checkpoint3")
		game.ReplicatedStorage.Events.Checkpoint3Touched:FireClient(player)
