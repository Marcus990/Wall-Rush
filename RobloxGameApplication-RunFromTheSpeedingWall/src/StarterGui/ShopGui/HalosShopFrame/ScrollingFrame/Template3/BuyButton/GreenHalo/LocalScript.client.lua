...
local function whatdoicallthisfunctionversion4(stringvalue)
...
button.MouseButton1Down:Connect(function()
	...
	elseif button.Text == "Unequip" then
		if player.Character:FindFirstChild("GreenHalo") then
...
GreenHaloForDatastoreEvent2.OnClientEvent:Connect(whatdoicallthisfunctionversion4)