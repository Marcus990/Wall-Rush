...
local function whatdoicallthisfunctionversion3(stringvalue)
...
button.MouseButton1Down:Connect(function()
	...
	if button.Text == "Equip" then
		if script.Parent.Parent.Parent.Parent.Template.BuyButton.RedTrail.Text == "Unequip" then
...
OrangeTrailForDatastoreEvent2.OnClientEvent:Connect(whatdoicallthisfunctionversion3)