...
local BooleanEvent2 = Events:WaitForChild("BooleanEvent2")
...
local function whatdoicallthisfunctionversion10(stringvalue)
...
button.MouseButton1Down:Connect(function()
	...
	elseif player.leaderstats.Coins.Value >= 50 and button.Text == "Buy" then
		BooleanEvent2:FireServer(game.Players.LocalPlayer)
		button.Parent.ImageColor3 = Color3.fromRGB(252, 1, 7)
...
WhiteTrailForDatastoreEvent2.OnClientEvent:Connect(whatdoicallthisfunctionversion10)