...
button.MouseButton1Down:Connect(function()
	...
	if button.Text == "Equip" then
		if script.Parent.Parent.Parent.Parent.Template.BuyButton.RedHalo.Text == "Unequip" then
	...
	elseif button.Text == "Unequip" then
		if player.Character:FindFirstChild("OrangeHalo") then
...
OrangeHaloForDatastoreEvent2.OnClientEvent:Connect(whatdoicallthisfunctionversion2)