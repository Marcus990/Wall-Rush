...
local function whatdoicallthisfunctionversion7(stringvalue)
...
button.MouseButton1Down:Connect(function()
	...
	elseif button.Text == "Unequip" then
		if player.Character:FindFirstChild("AquaHalo") then
...
AquaHaloForDatastoreEvent2.OnClientEvent:Connect(whatdoicallthisfunctionversion7)